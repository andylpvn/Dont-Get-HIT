...
// GAMEPAD VARIABLES
var haxis2 = gamepad_axis_value(1, gp_axislh);
var vaxis2= gamepad_axis_value(1, gp_axislv);
...
if (global.mychar == 20) 
{
	...
	if ( keyboard_check_released(ord("L")))
	{
	 ...
	 if (keyboard_check(ord("L")) || (haxis2 > 0)) // controller 2,leftStick pointing RIGHT) 
		{
		if (!place_meeting(x, y, o_chosen_player1))
		{
			x+=5;
	 ...
	 if (keyboard_check(ord("J")) || (haxis2 < 0)) // controller 2,leftStick pointing LEFT 
		{
		if (!place_meeting(x, y, o_chosen_player1))
		{
			x-=5;
